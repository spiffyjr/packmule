var ItemListDirective = function() {
    return {
        ...
        controller: [
            '$rootScope', '$scope', '$mdBottomSheet', 'BungieService', 'ItemService',
            function($rootScope, $scope, $mdBottomSheet, BungieService, ItemService) {
                ...
                $scope.getCharacter = function(charId) {
                    ...
                    var parts = [BungieService.getCharacterClass(character)];
